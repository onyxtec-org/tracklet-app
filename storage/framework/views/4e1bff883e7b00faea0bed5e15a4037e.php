...
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center <?php echo e($configData['navbarColor']); ?>" data-nav="brand-center">
        ...
        <ul class="nav navbar-nav">
          <li class="nav-item d-none d-lg-block">
            <a class="nav-link nav-link-style">
              <i class="ficon" data-feather="<?php echo e(($configData['theme'] === 'dark') ? 'sun' : 'moon'); ?>"></i>
            </a>
          </li>
        </ul>
      </div>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status"><?php echo e($user->organization->name); ?></span>
              <?php endif; ?>
            </div>
            <span class="avatar">
              <img class="round" src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="40" width="40">
  ...
  <form id="logout-form" method="POST" style="display: none;" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?></form>
  ...
  <!-- END: Header-->
<?php /**PATH /opt/lampp/htdocs/tracklet-app/resources/views/panels/navbar.blade.php ENDPATH**/ ?>