<?php $__env->startSection('title', 'Subscribe to Tracklet'); ?>
...
<div class="row justify-content-center">
    <div class="col-12 col-md-10 col-lg-8 col-xl-7">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-muted mb-0">Get started with <strong><?php echo e($organization->name); ?></strong> and unlock all Tracklet features</p>
        </div>
        ...
        <div class="card border-0 shadow-lg">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4 pb-3 border-bottom">
                    <?php if(isset($priceInfo) && $priceInfo): ?>
                        <div class="d-flex align-items-baseline justify-content-center">
                            <span class="h1 font-weight-bolder text-primary mb-0"><?php echo e($priceInfo['currency_symbol']); ?><?php echo e(number_format($priceInfo['monthly_price'], 0)); ?></span>
                            <span class="h4 text-muted ml-1 mb-0">/month</span>
                        </div>
                        <p class="text-muted small mb-0 mt-1">
                            <span class="text-success font-weight-bold"><?php echo e($priceInfo['formatted_annual']); ?>/year</span> billed annually
                        </p>
                        <p class="text-muted small mb-0 mt-1">
                            <span class="badge badge-light-success">Free for 30 days</span> then <?php echo e($priceInfo['formatted_annual']); ?>/year
                        </p>
                    <?php else: ?>
                        <div class="d-flex align-items-baseline justify-content-center">
...
$(document).ready(function() {
    ...
    $('#checkout-form').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("subscription.checkout.create")); ?>',
            method: 'POST',
            data: {
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tracklet-app/resources/views/subscription/checkout.blade.php ENDPATH**/ ?>